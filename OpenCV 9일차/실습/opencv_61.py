...
for idx, fname in enumerate(images):
    ...
    if ret == True:
        ...
        write_name = 'output/output3/corners_found' + str(idx) + '.jpg'
...
cv2.imwrite('output/output3/test_undist.jpg', dst)

dist_pickle = {}
dist_pickle["mtx"] = mtx
dist_pickle["dist"] = dist
pickle.dump(dist_pickle, open('output/output3/wide_dist_pickle.p', 'wb'))
