...
lower_green = (50, 65, 0)  # 자료형은 튜플형태로(H, S, V)
upper_green = (75, 255, 255)  # 자료형은 튜플형태로(H, S, V)
img_mask = cv2.inRange(img_hsv, lower_green, upper_green)   # 초록색 정보 추출(특정 범위 안에 있는 행렬 원소 검출)
