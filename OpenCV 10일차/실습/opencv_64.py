...
img_src = cv2.imread('img/img19.png', cv2.IMREAD_COLOR)
...
cont = cv2.hconcat([img_src, img_undist, img_grays, img_hls])
...
print(cont.shape, cont1.shape, cont2.shape, cont3.shape)
print(cont.dtype, cont1.dtype, cont2.dtype, cont3.dtype)
