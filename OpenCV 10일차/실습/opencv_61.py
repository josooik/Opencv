...
images = glob.glob('img/black_box_checkboard/t*.jpg')
...
for idx, fname in enumerate(images):
    ...
    if ret == True:
        ...
        write_name = 'output/output4/corners_found' + str(idx) + '.jpg'
...
img = cv2.imread('img/black_box_checkboard/t14.jpg')
...
cv2.imwrite('output/output4/test_undist.jpg', dst)
